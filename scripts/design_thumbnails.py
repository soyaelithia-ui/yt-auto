...
def main():
    scp_base = ARTIFACT_DIR / "scp_173_containment_1788480825325.jpg"
    ...
    scp_out = ARTIFACT_DIR / "redesigned_thumb_scp_173.jpg"
    aita_out = ARTIFACT_DIR / "redesigned_thumb_aita.jpg"
    horror_out = ARTIFACT_DIR / "redesigned_thumb_horror.jpg"
    ...
    print("Copied redesigned thumbnails into work/cli run directories.")
