...
Helpers: `src/media/encode_defaults.py` (`default_render_preset`, `default_render_crf`, `default_ffmpeg_threads`).
...
4. **Procedural segments** without subtitles: stream-copy the micro-loop when width/height already match.
