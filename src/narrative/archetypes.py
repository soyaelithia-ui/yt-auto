...
ARCHETYPE_PRESETS: Dict[NarrativeArchetype, Dict[str, Any]] = {
    NarrativeArchetype.HYDROACOUSTIC_TELEMETRY: {
        ...
        "visual_sequence": ["deep_space", "dark_forest", "deep_space"],
        "shader_sequence": ["deep_space", "dark_forest", "deep_space"],
    ...
    NarrativeArchetype.PROCEDURAL_INSTITUTIONAL_MANUAL: {
        ...
        "visual_sequence": ["tactical_chamber", "classified_terminal", "dark_forest"],
        "shader_sequence": ["tactical_chamber", "classified_terminal", "dark_forest"],
    ...
    NarrativeArchetype.SPECULATIVE_BIOLOGICAL_DOSSIER: {
        ...
        "visual_sequence": ["cosmic_horror", "tactical_chamber", "cosmic_horror"],
        "shader_sequence": ["cosmic_horror", "tactical_chamber", "cosmic_horror"],
