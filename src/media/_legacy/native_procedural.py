"""
DEPRECATED / QUARANTINED — Native Procedural Engine (wgpu-py / WGSL).

Moved under ``src.media._legacy``. Production SSOT (PDF v2.4.0): FFmpeg audiovisual
+ Pillow thumbs only. Do NOT use on pipeline/compositor/loop_worker/hybrid hot paths
unless ``ENABLE_NATIVE_PROCEDURAL=1``.

64-byte std140 uniforms; 256-byte row stride. Kept for opt-in experiments / historical tests.
"""
